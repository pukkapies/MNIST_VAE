...
def save_npy_datasets():
    ...
    np.save(curr_path + '/MNIST/validation_labels.npy', validation_labels)
    np.save(curr_path + '/MNIST/test_images.npy', test_images[:, :, :, 0])
    np.save(curr_path + '/MNIST/test_labels.npy', test_labels)
